...
<div class="container-fluid dashboard-content">
    <div class="row">
        <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
            ...
            @endif
            <form action="@if ($teacher) /teacher/update @else /teacher/save @endif" method="post">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" required="" name="contact"
                        ...
                        value="@if ($teacher){{$teacher->contact}}@endif">
                ...
                <div class="form-group">
                    ...
                    <input type="text" required="" name="email"
                        ...
                        value="@if ($teacher){{ $teacher->email }}@endif">
                ...
                <div class="form-group">
                    ...
                    <input type="date" required="" name="joining_date"
                        class="form-control @error('joining_data') is-invalid @enderror" id="joining_data"
                        value="@if ($teacher){{ $teacher->joining_date }}@endif">
